module neuron_core #(
    ...
    input  logic [31:0] pot_thresh [N],
    input  logic [31:0] randn      [N],
    output logic [31:0] o_pot,
    ...
    logic [6:0]  dec_index;
    logic [31:0] randn_tmp;
    logic [31:0] neur_data;
    logic [31:0] pot_thrs_diff;
    logic [31:0] pot_thresh_diff;
    logic [31:0] o_spike   [N];
    logic [31:0] spike_tmp [N];
    logic [31:0] dec     [Dims];
    /////////////// Done ///////////////
    ...
    always_ff @(posedge clk) begin 
        if (reset || reset_iteration) begin
            ...
            if (lif_AU.done_ws_spike_f) begin
