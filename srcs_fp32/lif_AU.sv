module lif_AU #(
    ...
    input  logic [31:0] i_pot,                // membrane potential state from  mem
    input  logic [31:0] i_dec_t   [Dims],     // Transposed Decoder
    input  logic [31:0] i_cmd     [Dims],     // Commands
    input  logic [31:0] i_err     [Dims],     // Calculation error
    input  logic [31:0] i_wf      [N],        // Fast Weights
    input  logic [31:0] i_ws      [N],        // Slow Weights
    input  logic [31:0] i_spike   [N],        // Spikes
    input  logic [31:0] i_spike_f [N],        // Filtered Spikes
    input  logic [31:0] randn,
    output logic [31:0] o_pot_reg,                // Memberane potential
    ...
    logic [31:0] leak_str;
    logic [31:0] pot_leak;
    logic [31:0] lambdaV_dt;
    logic [31:0] ws_spike_f_dt;
    logic [31:0] dec_err_k;
    logic [31:0] noise;
    logic [31:0] Gain_D_sqr;
    logic [31:0] noise_randn;
    logic [31:0] sum_0;
    logic [31:0] sum_1;
    logic [31:0] sum_2;
    logic [31:0] sum_3;
    logic [31:0] o_dec_cmd    [ROWS_A];
    logic [31:0] o_dec_err    [ROWS_A];
    logic [31:0] o_ws_spike_f [ROWS_A];
    logic [31:0] o_wf_spike   [ROWS_A]; 
