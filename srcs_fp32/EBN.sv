module EBN #(
    parameter N            = 64,
    parameter Dims         = 2,
    parameter dyn          = 32'h 41000000, // 8
    parameter NzMemb       = 32'h 38d1b717, // 0.0001
    parameter Gain_D       = 32'h 3c000000, // 0.0078125 (1/N/2) 
    parameter K            = 32'h 3a03126f, // 0.0005
    parameter LambdaV      = 32'h 42480000, // 50
    parameter Lambda       = 32'h 41200000, // 10
    parameter One          = 32'h 3f800000, // 1
    parameter Three        = 32'h 40400000, // 3
    parameter Eta_W        = 32'h 3e99999a, // 0.3
    parameter dt           = 32'h 38d1b717, // 0.0001
    ...
    output logic [31:0] o_x_0,
    output logic [31:0] o_x_1,
    output logic [31:0] o_x_est_0,
    output logic [31:0] o_x_est_1,
    output logic [31:0] pot_out,
    output logic [31:0] ws_out,
    output logic        done
);
    ...
    logic        load_complete;
    logic [31:0] i_wf             [N];
    logic [31:0] pot_thresh       [N];
    logic [31:0] randn            [N];
    logic [31:0] i_cmd            [Dims];
    logic [31:0] i_dec            [N* Dims];

    // Delayed Signals for Synaptic_core
    logic [31:0] old_spike_f_data [N];
    logic [31:0] old_err          [Dims];
    ...
    logic        done_spike_f;
    logic [31:0] spife_f_add;
    logic [31:0] o_spike_f        [N];
    
    // Signals from Desired_Dynamic
    logic        done_dyn; 
    logic [31:0] o_err       [Dims];
    logic [31:0] o_x         [Dims];
    logic [31:0] o_x_est     [Dims];

    // Signals for Spike_filter sync
    logic [31:0] spike_f_data     [N]; 
