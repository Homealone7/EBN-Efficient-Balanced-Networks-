module Dynamic_Error #(
    ...
    input  logic [31:0] i_dec   [Dims * N],    // Decoder
    output logic [31:0] o_err   [Dims],        // Calculation error
    output logic [31:0] o_x     [Dims],
    output logic [31:0] o_x_est [Dims],
    output logic        done
);
